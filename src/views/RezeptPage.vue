    ...
    <div class="rezept">
      ...
      <div class="rezept__details">
        <div class="rezept__info">
          ...
          <span class="rezept__info-data rezept__info-data--minutes">{{rezept.vorbereitungsZeit}}</span>
        ...
        <div class="rezept__info">
          ...
          <span class="rezept__info-data rezept__info-data--minutes">{{rezept.kochZeit}}</span>
          <span class="rezept__info-text">minuten |</span>
        </div>
        <div class="rezept__info">
          <svg class="rezept__info-icon">
          ...
          <span class="rezept__info-data rezept__info-data--people">{{rezept.portionen}}</span>
